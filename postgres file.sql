...
-- Do subscribed customer spend more? Compare average spend and total revenue between Subscribers and non
...
-- Segment Customer into new, returning and loyal based on their total numbers of previous purchases,
...
-- What is the revune contribution of each age group?
select age_group,
